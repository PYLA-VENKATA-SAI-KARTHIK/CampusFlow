  ...
  return (
    <div className="flex flex-wrap items-center gap-2.5 text-xs">
      <button
        ...
        disabled={loading}
        className={`px-3.5 py-2 rounded-xl font-bold transition-all shadow-xs flex items-center space-x-2 focus:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 ${
          isSubscribed
            ? 'bg-emerald-50 text-emerald-700 border border-emerald-200 hover:bg-emerald-100/80 focus-visible:ring-emerald-500'
            : 'bg-indigo-50 text-indigo-700 border border-indigo-200 hover:bg-indigo-100/80 focus-visible:ring-indigo-500'
        }`}
